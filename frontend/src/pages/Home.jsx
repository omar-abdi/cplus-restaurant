  ...
  return (
    <main className="overflow-hidden bg-[#fffaf3] text-[#27170f]">
      <section className="relative isolate px-6 pb-16 pt-12 sm:pt-16 lg:pb-24 lg:pt-24">
        ...
        <div className="home-glow absolute -right-24 top-10 -z-10 h-72 w-72 rounded-full bg-[#e9a354]/25 blur-3xl" />

        <div className="mx-auto grid max-w-7xl items-center gap-12 lg:grid-cols-[1fr_1.05fr] lg:gap-16">
          <div className="max-w-xl">
            <div className="home-reveal inline-flex items-center gap-2 rounded-full border border-[#d58e3d]/25 bg-white/75 px-4 py-2 text-xs font-bold uppercase tracking-[0.17em] text-[#a85f19] shadow-sm">
              <ChefHat size={16} /> Made with care, served with love
            </div>

            <h1 className="home-reveal home-delay-1 mt-6 text-5xl font-black leading-[1.04] tracking-tight text-[#2b1b14] sm:text-6xl lg:text-7xl">
              Welcome to our <span className="text-[#ca7d2e]">restaurant.</span>
            </h1>

            <p className="home-reveal home-delay-2 mt-6 max-w-lg text-base leading-8 text-[#654838] sm:text-lg">
              Discover freshly prepared meals, vibrant flavours, and your next favourite dish—all made for a great moment at the table.
            </p>

            <div className="home-reveal home-delay-3 mt-8 flex flex-col gap-3 sm:flex-row sm:items-center">
            ...
            <div className="home-reveal home-delay-4 mt-10 flex items-center gap-4">
          ...
          <div className="home-image-reveal relative mx-auto w-full max-w-xl lg:max-w-none">
            ...
            <img src={foodImages[0].src} alt="Pizza" className="home-float absolute -bottom-8 -left-5 hidden h-32 w-32 rounded-3xl border-4 border-[#fffaf3] object-cover shadow-xl sm:block" />
          </div>
        </div>
      </section>

      <section className="border-y border-[#ead9c6] bg-white px-6 py-10">
        <div className="mx-auto grid max-w-6xl gap-6 text-center sm:grid-cols-3"><div className="home-reveal home-delay-2"><p className="text-2xl font-black text-[#2b1b14]">Fresh daily</p><p className="mt-1 text-sm text-[#765a49]">Prepared when you order</p></div><div className="home-reveal home-delay-3"><p className="text-2xl font-black text-[#2b1b14]">Quality ingredients</p><p className="mt-1 text-sm text-[#765a49]">Flavour you can trust</p></div><div className="home-reveal home-delay-4"><p className="text-2xl font-black text-[#2b1b14]">Made for you</p><p className="mt-1 text-sm text-[#765a49]">A menu for every craving</p></div></div>
      </section>
    </main>
  );
}
